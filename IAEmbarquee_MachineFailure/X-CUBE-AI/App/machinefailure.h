/**
  ...
  ******************************************************************************
  */
#ifndef AI_MACHINEFAILURE_H
#define AI_MACHINEFAILURE_H

#include "machinefailure_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MACHINEFAILURE_MODEL_NAME          "machinefailure"
#define AI_MACHINEFAILURE_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_MACHINEFAILURE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MACHINEFAILURE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MACHINEFAILURE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MACHINEFAILURE_IN_NUM        (1)

AI_DEPRECATED
#define AI_MACHINEFAILURE_IN \
  ai_machinefailure_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MACHINEFAILURE_IN_SIZE { \
  AI_MACHINEFAILURE_IN_1_SIZE, \
}
#define AI_MACHINEFAILURE_IN_SIZE_BYTES { \
  AI_MACHINEFAILURE_IN_1_SIZE_BYTES, \
}
#define AI_MACHINEFAILURE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MACHINEFAILURE_IN_1_CHANNEL     (7)
#define AI_MACHINEFAILURE_IN_1_SIZE        (7)
#define AI_MACHINEFAILURE_IN_1_SIZE_BYTES  (28)

/******************************************************************************/
#define AI_MACHINEFAILURE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MACHINEFAILURE_OUT \
  ai_machinefailure_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MACHINEFAILURE_OUT_SIZE { \
  AI_MACHINEFAILURE_OUT_1_SIZE, \
}
#define AI_MACHINEFAILURE_OUT_SIZE_BYTES { \
  AI_MACHINEFAILURE_OUT_1_SIZE_BYTES, \
}
#define AI_MACHINEFAILURE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MACHINEFAILURE_OUT_1_CHANNEL     (5)
#define AI_MACHINEFAILURE_OUT_1_SIZE        (5)
#define AI_MACHINEFAILURE_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_MACHINEFAILURE_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup machinefailure
 ...
 * @ref ai_machinefailure_create. Both the activations memory buffer 
 ...
 * using @ref ai_machinefailure_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_machinefailure_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_machinefailure_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MACHINEFAILURE_*
 * defines into file @ref machinefailure.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_machinefailure_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MACHINEFAILURE_H */
